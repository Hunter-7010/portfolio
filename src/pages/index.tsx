...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#101212] to-[#08201D] dark">
        <Navbar />

        <section className="relative pt-24 pb-10 sm:pt-32 sm:pb-16 lg:min-h-[1000px] lg:pb-24">
